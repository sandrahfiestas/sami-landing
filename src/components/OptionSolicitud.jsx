...
function OptionSolicitud() {
  return(
    ...
    <div className="options__texts">
      ...
      <p className="options-description">Envía requerimientos a las áreas internas de tu empresa. Mantente al tanto si los documentos solicitados están por vencer o fueron entregados a tiempo.</p>
    </div>
    <div className="options-images">
      <div className="options-images__left">
        <img src={soliDocIcon} alt="imagen tarjeta" className="options-images__left-cardCase"/>
      </div>
