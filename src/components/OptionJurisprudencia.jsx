...
function OptionJurisprudencia() {
  return(
    ...
    <div className="options__texts">
      ...
      <p className="options-description">Agiliza el tiempo que usas buscando resoluciones. Proximamente en Sami podrás contar con acceso automatizado a jurisprudencia relevante para tu cartera.</p>
    </div>
    <div className="options-images">
      <div className="options-images__left">
        <img src={jurisprudenciaIcon} alt="imagen tarjeta" className="options-images__left-cardCase"/>
      </div>
